...
public final class UserTextureRepository extends BaseDatabaseRepository {
    ...
    public Completable save(UserTexture userTexture) {
        ...
        return Completable.create(new Completable.OnSubscribe() {
            ...
            public void call(CompletableSubscriber subscriber) {
                getRootReference().child(PATH_USER_TEXTURES)
    ...
    public Observable<UserTexture> find(String userId, String textureId) {
        ...
        return Observable.<DatabaseReference>create(subscriber -> {
            DatabaseReference reference = getRootReference().child(PATH_USER_TEXTURES)
                                                            .child(userId)
                                                            .child(textureId);
    ...
    public Observable<UserTexture> findAll(String userId) {
        ...
        return Observable.<Query>create(subscriber -> {
            Query query = getRootReference().child(PATH_USER_TEXTURES)
                                            .child(userId)
